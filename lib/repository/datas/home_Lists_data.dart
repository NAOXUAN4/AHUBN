...
class HomeListsData {
  ...
  HomeListsData.fromJson(Map<String, dynamic>? json) {
    curPage = json?['curPage'];
    if (json?['datas'] != null) {
      datas = [];
      json?['datas'].forEach((v) {
        datas?.add(HomeItemsData.fromJson(v));
      });
    }
    offset = json?['offset'];
    over = json?['over'];
...
class HomeTopListData {
  List<HomeItemsData>? topList = [];

  HomeTopListData.fromJson(dynamic json) {
    if (json is List) {
      for (var element in json) {
        topList?.add(HomeItemsData.fromJson(element));
      }
    }
  }
}
...
class HomeItemsData {
  ...
  HomeItemsData.fromJson(Map<String, dynamic>? json) {
